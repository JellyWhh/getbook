...
public class MainFragment extends Fragment {
	...
	private LinearLayout ll_tab_message, ll_tab_home, ll_tab_setting,
			ll_tab_procedure;
	private ImageView iv_tab_message, iv_tab_home, iv_tab_setting,
			iv_tab_procedure;
	...
	private Fragment messageFragment, homeFragment, settingFragment,
			procedureFragment;
	...
	class MyOnPageChangeListener implements OnPageChangeListener {
		...
		public void onPageSelected(int arg0) {
			...
			case 0:
				...
				iv_tab_procedure
						.setBackgroundResource(R.drawable.icon_procedure_nor);
				iv_tab_setting
			...
			case 2:
				...
				iv_tab_message
						.setBackgroundResource(R.drawable.icon_message_nor);
				iv_tab_procedure
						.setBackgroundResource(R.drawable.icon_procedure_sel);
				iv_tab_setting
						.setBackgroundResource(R.drawable.icon_setting_nor);
